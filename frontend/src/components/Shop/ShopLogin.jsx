...
const ShopLogin = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "rgba(79, 116, 65, 0.25)" }} // Green-themed background with opacity
    >
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className={`${styles.noramlFlex} justify-between`}>
              <div className={`${styles.noramlFlex}`}>
                <input
                  ...
                  name="remember-me"
                  id="remember-me"
                  className="h-4 w-4 text-[#689956] focus:ring-[#689956] border-gray-300 rounded"
                />
                <label
                  htmlFor="remember-me"
              ...
              <div className="text-sm">
                <a
                  ...
                  className="font-medium text-[#689956] hover:text-[#4F7441]"
                >
            ...
            <div className={`${styles.noramlFlex} w-full`}>
              ...
              <Link to="/shop-create" className="text-[#689956] pl-2">
                Sign Up
              </Link>
            </div>
          </form>
